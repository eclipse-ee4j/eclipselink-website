<?php
  ...
  $theme = "Nova";
	...
	$Nav->addCustomNav("Home", "/eclipselink/index.html", "_self", 2);

 	$Nav->addNavSeparator("Downloads", "/eclipselink/#download");
	$Nav->addCustomNav("2.6.0", "/eclipselink/#download", "_self", 2);
